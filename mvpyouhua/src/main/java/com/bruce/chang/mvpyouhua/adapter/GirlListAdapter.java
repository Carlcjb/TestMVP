package com.bruce.chang.mvpyouhua.adapter;
...
public class GirlListAdapter extends BaseAdapter {
    ...
    public GirlListAdapter(Context mContext, List<GirlBean> mData) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.adapter_girl_list, null);
